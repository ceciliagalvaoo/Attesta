...
that directly, by name, rather than asserting novelty in general terms; Table 15 compares
them one by one.

<div className="at-figure">

**Table 15: the five official Midnight examples and what they do not cover**
...
| [`midnight-did`](https://github.com/midnightntwrk/midnight-did) | A reference `did:midnight` method: Compact contract, DID domain model, TypeScript API | Identifier resolution, not the lifecycle of a fact asserted *about* an identity, with no notion of an attestation going stale or being revoked. |
...
*Source: the authors (2026), based on the public repositories linked in the table.*
