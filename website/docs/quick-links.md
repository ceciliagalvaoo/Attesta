...
**Figure 1: a redacted attestation receiving the LIVE stamp, the image that sums up the product**

![A compliance document whose fields are all covered by black redaction bars, with a green LIVE stamp landing on it](/img/brand/stamp-live.gif)
